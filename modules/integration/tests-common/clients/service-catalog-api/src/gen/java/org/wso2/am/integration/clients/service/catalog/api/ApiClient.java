...
import org.wso2.am.integration.clients.service.catalog.api.auth.Authentication;
import org.wso2.am.integration.clients.service.catalog.api.auth.HttpBasicAuth;
import org.wso2.am.integration.clients.service.catalog.api.auth.HttpBearerAuth;
import org.wso2.am.integration.clients.service.catalog.api.auth.ApiKeyAuth;
import org.wso2.am.integration.clients.service.catalog.api.auth.OAuth;
import org.wso2.am.integration.clients.service.catalog.api.auth.RetryingOAuth;
import org.wso2.am.integration.clients.service.catalog.api.auth.OAuthFlow;

public class ApiClient {

    private String basePath = "https://apis.wso2.com/api/service-catalog/v0";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://apis.wso2.com/api/service-catalog/v0
    ...
    public RequestBody buildRequestBodyMultipart(Map<String, Object> formParams)throws ApiException {
        ...
        for (Entry<String, Object> param : formParams.entrySet()) {
            if (param.getValue() instanceof File) {
                ...
                Headers partHeaders = Headers.of("Content-Disposition", "form-data; name=\"" + param.getKey() + "\"");
                mpBuilder.addPart(partHeaders, RequestBody.create(MediaType.parse("application/json"), parameterToString(param.getValue())));
            }
        }
