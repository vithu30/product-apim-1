...
public class KeyManagersCollectionApi {
     ...
     */
    public okhttp3.Call keyManagersGetCall(String xWSO2Tenant, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call keyManagersGetValidateBeforeCall(String xWSO2Tenant, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = keyManagersGetCall(xWSO2Tenant, _callback);
        return localVarCall;
    ...
    public KeyManagerListDTO keyManagersGet(String xWSO2Tenant) throws ApiException {
        ApiResponse<KeyManagerListDTO> localVarResp = keyManagersGetWithHttpInfo(xWSO2Tenant);
    ...
    public ApiResponse<KeyManagerListDTO> keyManagersGetWithHttpInfo(String xWSO2Tenant) throws ApiException {
        okhttp3.Call localVarCall = keyManagersGetValidateBeforeCall(xWSO2Tenant, null);
     ...
     */
    public okhttp3.Call keyManagersGetAsync(String xWSO2Tenant, final ApiCallback<KeyManagerListDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = keyManagersGetValidateBeforeCall(xWSO2Tenant, _callback);
        Type localVarReturnType = new TypeToken<KeyManagerListDTO>(){}.getType();
