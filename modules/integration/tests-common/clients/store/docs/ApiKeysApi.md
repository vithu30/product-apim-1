...
> APIKeyDTO applicationsApplicationIdApiKeysKeyTypeGeneratePost(applicationId, keyType, ifMatch, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      APIKeyDTO result = apiInstance.applicationsApplicationIdApiKeysKeyTypeGeneratePost(applicationId, keyType, ifMatch, body);
...
> applicationsApplicationIdApiKeysKeyTypeRevokePost(applicationId, keyType, ifMatch, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.applicationsApplicationIdApiKeysKeyTypeRevokePost(applicationId, keyType, ifMatch, body);
    } catch (ApiException e) {
