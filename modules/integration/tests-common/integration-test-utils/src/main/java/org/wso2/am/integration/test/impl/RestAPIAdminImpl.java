...
public class RestAPIAdminImpl {
    ...
    public ApiResponse<ApplicationThrottlePolicyDTO> addApplicationThrottlingPolicy(
        ...
        return applicationPolicyCollectionApi
                .throttlingPoliciesApplicationPostWithHttpInfo(Constants.APPLICATION_JSON_CONTENT_TYPE, applicationThrottlePolicyDTO);
    }
    ...
    public ApiResponse<AdvancedThrottlePolicyDTO> addAdvancedThrottlingPolicy(
        ...
        return advancedPolicyCollectionApi.throttlingPoliciesAdvancedPostWithHttpInfo(Constants
                .APPLICATION_JSON_CONTENT_TYPE, advancedThrottlePolicyDTO);
    ...
    public ApiResponse<AdvancedThrottlePolicyDTO> updateAdvancedThrottlingPolicy(String policyId,
        ...
        return advancedPolicyIndividualApi
                .throttlingPoliciesAdvancedPolicyIdPutWithHttpInfo(policyId, Constants
                        .APPLICATION_JSON_CONTENT_TYPE, advancedThrottlePolicyDTO,null, null);
    }
    ...
    public ApiResponse<ApplicationListDTO> getApplications(String user, Integer limit, Integer offset,
        ...
        return applicationCollectionApi.applicationsGetWithHttpInfo(user, limit, offset, null, null, null,appTenantDomain);
    }
